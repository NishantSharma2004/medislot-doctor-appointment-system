...
export const defaultHomePageCmsData: CmsHomePageData = {
  ...
  pricing: {
    ...
    heroTitle: "Care that fits your well-being",
    heroSubtitle: "Durrmi provides you with multiple sessions and a single session at your convenience. Talk to our therapists now. -Let us not compromise your well-being",
    heroCtaLabel: "FIND YOUR BEST PLAN",
    plansHeaderTitle: "Choose what your heart is ready for",
    plansHeaderSubtitle: "Start your journey with a few simple steps with our Experts",
    ...
    planCards: [
      {
        ...
        accentColor: "yellow",
        features: [
          "Know the price before you tap book",
          "Handpick your consultant + the time that fits your life.",
          "One and done — no subscriptions, no commitment",
        ],
      ...
      },
      {
        ...
        accentColor: "orange",
        features: [
          "Single sessions-no strings attached",
          "See the rates-before you book- no surprises.",
          "Choose your consultant & limit slot.",
        ],
        ctaLabel: "Book a session",
      },
      {
        ...
        accentColor: "blue",
        features: [
          "Just one session, cancel-anytime energy",
          "Full transparency: rate's on the table upfront",
          "You're in control — choose who and when",
        ],
        ctaLabel: "Book a session",
      },
      {
        ...
        accentColor: "green",
        features: [
          "No rotating door — the same trusted face each time",
          "All-in on your progress, full-time.",
          "Dedicated therapists, fully in your corner",
        ],
        ctaLabel: "Book a session",
      },
    ],
    corporateBanner: {
      title: "Let our care team take the initiative with full course support",
      badge: "THE TOTAL CARE PLAN",
      description: "One simple plan with complete care: this all-in-one bundle brings everything together.",
      ctaLabel: "Contact sales",
    },
    completeCareBundle: {
      title: "THE TOTAL CARE PLAN",
      subtitle: "It will be based on therapist, on the session & time.",
      cards: [
        {
          id: "bundle-1",
