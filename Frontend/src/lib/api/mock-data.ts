...
export const mockDoctors: DoctorDto[] = [
  {
    ...
    about: "Consults on routine health concerns, preventive check-ups and follow-up care.",
  ...
  },
  {
    ...
    clinicName: "Apollo Heart Center",
    city: "Bengaluru",
    languages: ["English", "Tulu", "Hindi"],
    about: "Consults on cardiac reviews, ECG interpretation and post-procedure care planning.",
  ...
  },
  {
    ...
    consultationFee: 900,
    clinicName: "Hillview Joint Care",
    city: "Pune",
  ...
  },
  {
    ...
    about: "Experienced Senior Physician specializing in preventative medicine and lifestyle management.",
  ...
  },
  {
    ...
    clinicName: "NeuroCare Spine Clinic",
    city: "Delhi",
    languages: ["English", "Hindi"],
    about: "Specialist in migraine management, nerve disorders, and comprehensive neurological evaluations.",
    registrationNumber: "DMC-44512",
  },
  {
    id: "doc-9",
    ...
    consultationFee: 850,
    clinicName: "Mother & Child Wellness",
    city: "Mumbai",
    languages: ["English", "Marathi", "Hindi"],
    about: "Consults on antenatal care, hormonal health, and routine gynaecological reviews.",
    registrationNumber: "MMC-991823",
  },
  {
    id: "doc-10",
    fullName: "Dr. Alok Banerjee",
    specialization: "Ophthalmology",
    qualifications: "MBBS, MS (Ophthalmology)",
    yearsOfExperience: 9,
    consultationFee: 700,
    clinicName: "VisionFirst Eye Hospital",
    city: "Bengaluru",
    languages: ["English", "Bengali", "Hindi"],
    about: "Specializes in vision testing, cataract consultations, and laser eye treatment advice.",
    registrationNumber: "KMC-671200",
  },
  {
    id: "doc-11",
    ...
    clinicName: "MindCare Counseling Center",
    city: "Hyderabad",
    languages: ["English", "Hindi", "Urdu"],
    about: "Consults on anxiety, stress management, mood disorders, and wellness counseling.",
    registrationNumber: "TSMC-881290",
  },
  {
    id: "doc-12",
    fullName: "Dr. Swati Joshi",
    ...
    about: "Provides root canal treatments, teeth alignment advice, and routine dental scaling.",
    registrationNumber: "MDC-33410",
  },
];
